...
void Graphics_Create(int screen_width, int screen_height)
{
    ...
    textures_g[Cat_Prop][Prop_Office_Desk_Computer] = IMG_LoadTexture(renderer, "img/prop/office_desk_computer.png");
    textures_g[Cat_Prop][Prop_Bathroom_Sink] = IMG_LoadTexture(renderer, "img/prop/bathroom_sink.png");
    textures_g[Cat_Prop][Prop_Bathtub] = IMG_LoadTexture(renderer, "img/prop/bathtub.png");
    textures_g[Cat_Prop][Prop_WC] = IMG_LoadTexture(renderer, "img/prop/wc.png");
